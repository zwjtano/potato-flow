...
- License: MIT
- License text: `recorder-core/LICENSE`

Local changes restrict the built-in live recorder plugins and WebUI choices to Bilibili Live and Douyu, and integrate the recorder with PotatoFlow.
...
- License text: `potatoflow-app/LICENSE`
