...
阵亡或操作任何英雄。即使人物名和英雄名在相邻弹幕中同时出现，也禁止建立任何“人物→英雄”关系；
只能写“英雄甲对阵英雄乙”等不带选手归属的中性比赛事实。只有 verified_live_context.game 中存在结构化
身份记录时，才允许把其中的 hero 绑定给当前主播。弹幕只能证明讨论内容，不能证明英雄归属。
...
禁止写成当前主播正在操刀任何英雄，也禁止把其他人物与英雄绑定。若只知道两个英雄出现在对局中，
只能写“英雄甲对阵英雄乙”，不得猜成“主播操刀英雄甲”或“某人使用英雄乙”。
