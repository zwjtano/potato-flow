...
"""Helpers for passing an optional Cookie file to the Douyin recorder."""
...
def normalize_douyin_cookie(content: str | bytes) -> str:
    """Convert an export to the recorder's minimal Douyin Cookie header."""
...
def missing_douyin_cookie_names(content: str | bytes) -> tuple[str, ...]:
    """Return required recorder Cookie names missing from an import."""
