...
from .submission_engine import upload_with_recorder
...
class BilibiliUploader:
    ...
    def _upload_video_unlocked(
        ...
        try:
            ...
            upload_engine = str(
                upload_config.get("BILIBILI_UPLOAD_ENGINE") or "recorder"
            ).strip().lower()
            if upload_engine in {"recorder", "biliup"}:
                self.log(
                    f"使用内置投稿引擎，全局线路："
                ...
                submission_ok, submission_result = upload_with_recorder(
                ...
                if (
                    ...
                    and isinstance(submission_result, dict)
                ):
                    ...
                    if not edit_ok:
                        ...
                        submission_result["cover43_error"] = str(edit_result)
                    elif isinstance(edit_result, dict):
                        submission_result = edit_result
                return submission_ok, submission_result
